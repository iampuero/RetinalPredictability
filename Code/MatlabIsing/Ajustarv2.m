...
load('/home/iampuero/Documents/Memoria/Data/Fishmovie/IST-2017-61-v1+1_bint_fishmovie32_100.mat');


%load(strcat(loadfolder,'/',loadfile));
binnedSpikes = squeeze(bint(1,1:25,:));
...
etaH = 0.001; % L2 regularization on fileds h
etaJ = 0.0500; % L2 regularization on couplings J
